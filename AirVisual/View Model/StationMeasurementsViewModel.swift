//
//  StationMeasurementsViewModel.swift
//  AirVisual
//
...
class StationMeasurementsViewModel: ObservableObject{
    let id: String
    
    var searchStationMeasurementsString = "https://airvisual1.p.rapidapi.com/stations/v2/get-measurements?id="
    let headers = [
    ...
    func fetchMeasurements(){
        searchStationMeasurementsString += id
        
        guard let url = URL(string: searchStationMeasurementsString) else{
            hasError = true
...
extension StationMeasurementsViewModel{
